...
%global github_commit    a370e5b95e509a7809d11f3d280acfc9310d464b
...
sed 's#Doctrine/Common/ClassLoader.php#%{phpdir}/Doctrine/Common/ClassLoader.php#' \
...
%changelog
* Sun Jan 18 2015 Shawn Iwinski <shawn.iwinski@gmail.com> - 2.4.4-1
- Updated to 2.4.4
- Removed patch %%{name}-2.4.2-primary_index.patch (causes tests to fail)
- Added tests
- %%license usage
